...
//     if (result.isAuth) {
//       // Permission granted, proceed with loading albums
//       await _loadAlbums();
//     } else {
//       // Permission denied
...
//         print('No albums with media found.');
//       }
//
//       _albums = nonEmptyAlbums;
//       filteredAlbums = nonEmptyAlbums;
...
//     }).toList();
//     print("Filtered Albums: ${filteredAlbums.length}");
//     notifyListeners();
//   }
//
...
class AlbumsController extends ChangeNotifier {
  ...
  AlbumsController() {
    requestPermissionAndLoadAlbums();
